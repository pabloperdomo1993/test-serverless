...
var userUpdate = function (event, _context) { return __awaiter(void 0, void 0, void 0, function () {
    var data, paramsSearch, user, _a, paramsSave, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                _a = user;
                return [4 /*yield*/, (0, embedding_1.createEmbedding)(user.name)];
            case 2:
                _a.nameData = _b.sent();
                paramsSave = {
                    type: 'save',
