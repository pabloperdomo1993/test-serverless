...
var userSave = function (event, _context) { return __awaiter(void 0, void 0, void 0, function () {
    var dataModel, body, urlExternalApi, response, model, numbers, paramsSearch, existingUsers_1, newUsers, paramsSave, responseSave, error_1;
        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                newUsers = model.filter(function (user) {
                    return !existingUsers_1.some(function (existingUser) { return existingUser.number === user.number; });
                });
                paramsSave = {
                    type: 'save',
                    entity: 'Search',
                ...
                return [4 /*yield*/, (0, connection_1.connection)(paramsSave)];
            case 4:
